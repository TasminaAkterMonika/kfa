						...
						<fieldset><legend> Contact Us</legend>
						     ...
						     class='form-control form-control-sm ' /> 
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='office_description' id='office_description' value='{{ $row['office_description'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='contact_description' id='contact_description' value='{{ $row['contact_description'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
									  ...
									  <div class="form-group row  " >
										...
										<div class="col-md-6">
										  <input  type='text' name='working _description' id='working _description' value='{{ $row['working _description'] }}' 
						     class='form-control form-control-sm ' /> 
										 </div> 
										 <div class="col-md-2">
